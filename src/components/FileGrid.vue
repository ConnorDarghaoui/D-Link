  ...
  >
    <div
      ...
      :class="{
        ...
        'hover:bg-gray-50 dark:hover:bg-gray-800': !isSelected(file),
      }"
    ...
    >
      ...
      <span
        class="text-xs text-center text-gray-700 dark:text-gray-300 break-all line-clamp-2"
        :title="file.path"
      >
        {{ file.path }}
      </span>
      <span v-if="!file.isDir" class="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">
